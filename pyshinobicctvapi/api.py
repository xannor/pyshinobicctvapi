...
class Manager:
    ...
    async def add(self, key: Union[Key,dict]):
        ...
        body = {
            "data": {
                ...
                "details": { wk: key.get("details", {}).get(wk, DEFAULT["details"][wk]) for wk in DEFAULT["details"].keys() }
            }
        }

        json = await self._connection.post(self._connection.action_url(ACTION,'add'), body)
        return Key(json['api'])
    ...
    async def delete(self, key: Union[Key,dict]):
        ...
        await self._connection.post(self._connection.action_url(ACTION, 'delete'), body={
            "data": {
                "code": key.get('code')
            }
        })
...
class Details:
    ...
    def auth_socket(self) -> bool:
        return self._details.setdefault('auth_socket', DEFAULT['details'].get('auth_socket')) == '1'
    ...
    def get_monitors(self) -> bool:
        return self._details.setdefault('get_monitors', DEFAULT['details'].get('get_monitors')) == '1'
    ...
    def control_monitors(self) -> bool:
        return self._details.setdefault('control_monitors', DEFAULT['details'].get('control_monitors')) == '1'
    ...
    def get_logs(self) -> bool:
        return self._details.setdefault('get_logs', DEFAULT['details'].get('get_logs')) == '1'
    ...
    def watch_stream(self) -> bool:
        return self._details.setdefault('watch_stream', DEFAULT['details'].get('watch_stream')) == '1'
    ...
    def watch_snapshot(self) -> bool:
        return self._details.setdefault('watch_snapshot', DEFAULT['details'].get('watch_snapshot')) == '1'
    ...
    def watch_videos(self) -> bool:
        return self._details.setdefault('watch_videos', DEFAULT['details'].get('watch_videos')) == '1'
    ...
    def delete_videos(self) -> bool:
        return self._details.setdefault('delete_videos', DEFAULT['details'].get('delete_videos')) == '1'
